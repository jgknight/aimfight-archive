...
function defineUserNameHandlers()
{
   ...
   player_2._txt.onKillFocus = function()
   {
      if(this.text == "")
      {
         this.text = "Enter opponent\'s screen name";
      }
   };
...
{
   if(player_1._txt.text == "Enter your screen name" || player_2._txt.text == "Enter opponent\'s screen name" || player_1._txt.text == "" || player_2._txt.text == "")
   {
      trace("RED FLAG GOT IT");
...
{
   attachMovie("GraphHolder","user_1",777);
   attachMovie("GraphHolder","user_2",778);
   user_1._x = 300;
   user_1._y = 277;
   user_2._x = 460;
   user_2._y = 277;
...
{
   attachMovie("fightAgain","fightAgain",10,{_x:80,_y:185});
...
function graphAnimationCallBack()
{
   if(score1 > score2)
   {
      _root.results_mc.gotoAndStop("win");
   }
   else if(score1 == score2)
   {
      _root.results_mc.gotoAndStop("win");
   ...
   {
      _root.results_mc.gotoAndStop("lose");
   }
...
_root.partnerURL = "http://www.verbnow.com";
_root.superBuddyURL_win = "http://aolexpressions.aol.com/search.adp?clientId=2&search=aimfight";
_root.superBuddyURL_lose = "http://aolexpressions.aol.com/main.adp?exptypeid=0&catid=56&subcatid=2083";
